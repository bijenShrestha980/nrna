const ColoredIncomeCard = () => {
  return (
    <div className="flex flex-cols gap-4 p-8 bg-teal-400 w-full text-white transition-all ease-in-out duration-300 rounded-xl shadow-md cursor-pointer hover:-translate-y-1 hover:scale-105 hover:shadow-xl max-h-[205px] group">
...
export default ColoredIncomeCard;
